          ...
          <div class="row">
            <div class="col-md-12">
              <div id="main-slider" class="owl-carousel owl-theme">
                <div class="item"><img src="<%=request.getContextPath() %>/resources/public/img/main-slider1.jpg" alt="" class="img-fluid"></div>
                <div class="item"><img src="<%=request.getContextPath() %>/resources/public/img/main-slider2.jpg" alt="" class="img-fluid"></div>
                <div class="item"><img src="<%=request.getContextPath() %>/resources/public/img/main-slider3.jpg" alt="" class="img-fluid"></div>
                <div class="item"><img src="<%=request.getContextPath() %>/resources/public/img/main-slider4.jpg" alt="" class="img-fluid"></div>
              </div>
              <!-- /#main-slider-->
            </div>
          </div>
          ...
          <div class="col-md-12">
            <div class="box slideshow">
              ...
              <div id="get-inspired" class="owl-carousel owl-theme">
                <div class="item"><a href="#"><img src="<%=request.getContextPath() %>/resources/public/img/getinspired1.jpg" alt="Get inspired" class="img-fluid"></a></div>
                <div class="item"><a href="#"><img src="<%=request.getContextPath() %>/resources/public/img/getinspired2.jpg" alt="Get inspired" class="img-fluid"></a></div>
                <div class="item"><a href="#"><img src="<%=request.getContextPath() %>/resources/public/img/getinspired3.jpg" alt="Get inspired" class="img-fluid"></a></div>
              </div>
            </div>
          </div>
        </div>
