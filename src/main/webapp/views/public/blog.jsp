            ...
            *** LEFT COLUMN ***
            ...
            <div id="blog-listing" class="col-lg-9">
              ...
              <div class="post">
                ...
                <div class="image"><a href="post.html"><img src="<%=request.getContextPath() %>/resources/public/img/blog2.jpg" alt="Example blog post alt" class="img-fluid"></a></div>
              ...
              <div class="post">
                ...
                <hr>
                <p class="date-comments"><a href="post.html"><i class="fa fa-calendar-o"></i> June 20, 2013</a><a href="post.html"><i class="fa fa-comment-o"></i> 8 Comments</a></p>
                <div class="image"><a href="post.html"><img src="<%=request.getContextPath() %>/resources/public/img/blog.jpg" alt="Example blog post alt" class="img-fluid"></a></div>
                <p class="intro">Pellentesque habitant morbi tristique senectus et netus et malesuada fames ac turpis egestas. Vestibulum tortor quam, feugiat vitae, ultricies eget, tempor sit amet, ante. Donec eu libero sit amet quam egestas semper. Aenean ultricies mi vitae est. Mauris placerat eleifend leo.</p>
                <p class="read-more"><a href="post.html" class="btn btn-primary">Continue reading</a></p>
              </div>
              <div class="pager d-flex justify-content-between">
                <div class="previous"><a href="#" class="btn btn-outline-primary">â Older</a></div>
                <div class="next disabled"><a href="#" class="btn btn-outline-secondary disabled">Newer â        </a></div>
              </div>
            </div>
            <!-- /.col-lg-9-->
            <!-- *** LEFT COLUMN END ***-->
            ...
            <div class="col-lg-3">
              ...
              *** BLOG MENU ***
              ...
              <!-- /.col-lg-3-->
              <!-- *** BLOG MENU END ***-->
              <div class="banner"><a href="#"><img src="<%=request.getContextPath() %>/resources/public/img/banner.jpg" alt="sales 2014" class="img-fluid"></a></div>
            </div>
          </div>
        </div>
      </div>
