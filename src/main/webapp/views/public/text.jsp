          ...
          <div class="row">
            ...
            <div class="col-lg-9">
              <div id="text-page" class="box">
                ...
                <div class="row">
                  <div class="col-md-4">
                    <p class="text-center"><img src="<%=request.getContextPath() %>/resources/public/img/detailsquare.jpg" alt="" class="img-circle img-fluid"></p>
                    <p class="text-center">circle</p>
                  </div>
                  <div class="col-md-4">
                    <p class="text-center"><img src="<%=request.getContextPath() %>/resources/public/img/detailsquare.jpg" alt="" class="img-thumbnail img-fluid"></p>
                    <p class="text-center">thumbnail</p>
                  </div>
                  <div class="col-md-4">
                    <p class="text-center"><img src="<%=request.getContextPath() %>/resources/public/img/detailsquare.jpg" alt="" class="rounded-circle img-fluid"></p>
